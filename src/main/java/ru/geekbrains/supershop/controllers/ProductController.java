...
import ru.geekbrains.supershop.validation.ValidUUID;
...
public class ProductController {
    ...
    @GetMapping("/{id}")
    public String getOneProduct(Model model, @PathVariable("id") @ValidUUID String id) throws ProductNotFoundException {
    ...
    public @ResponseBody byte[] getImage(@PathVariable("id") @ValidUUID String id) {
