...
-- New table for Product imager relation
create table productsimages
(
    product uuid not null
        constraint productsimages_product_id_fk
            references product
            on update cascade on delete cascade,
    image uuid not null
        constraint productsimages_image_id_fk
            references image
            on update cascade on delete cascade,
    constraint productsimages_pk
        primary key (product, image)
);


alter table productsimages owner to postgres;
